...
class SevenSegment
{
               ...
               int   p_space)
  {
    ...
    segments[0] = new Segment(p_segmentsColor, 0, 0, segments_width, segments_height);
    segments[1] = new Segment(p_segmentsColor, segments_width + space, segments_height + space, segments_height, segments_width);
    segments[2] = new Segment(p_segmentsColor, segments_width + space, 2*(segments_height + space) + segments_width, segments_height, segments_width);
    segments[3] = new Segment(p_segmentsColor, 0, 2*(segments_width + 2*space + segments_height), segments_width, segments_height);
    segments[4] = new Segment(p_segmentsColor, -(segments_height + space), 2*(segments_height + space) + segments_width, segments_height, segments_width);
    segments[5] = new Segment(p_segmentsColor, -(segments_height + space), segments_height + space, segments_height, segments_width);
    segments[6] = new Segment(p_segmentsColor, 0, segments_width + 2*space + segments_height, segments_width, segments_height);
  }
